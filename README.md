...
- _[FreeSurfer](https://surfer.nmr.mgh.harvard.edu/) (v.7.4.1 used for the article._: Requires Unix system (e.g. Linux or MacOS), but may also be run using WSL on Windows. May optionally be replaced by FastSurfer.
